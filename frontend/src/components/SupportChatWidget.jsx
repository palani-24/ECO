      ...
      {!isOpen && (
        ...
        >
          <div className="relative flex items-center justify-center">
            <div className="h-9 w-9 sm:h-9 sm:w-9 rounded-full bg-white/20 flex items-center justify-center text-lg backdrop-blur-sm shadow-inner group-hover:rotate-12 transition-transform">
              💬
            </div>
            {unreadAdminCount > 0 ? (
