...
const MobileEcoHome = ({ 
  ...
  return (
    <div className="min-h-screen bg-[#F4F7F6] dark:bg-[#07131F] text-slate-900 dark:text-slate-100 pb-24 font-sans select-none">
      ...
      {/* 10. UNIFIED CITIZEN BOTTOM NAVIGATION BAR (Image 2 - Exactly 5 tabs) */}
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-t border-slate-200 dark:border-slate-800 py-1.5 px-3 shadow-lg">
        <div className="max-w-md mx-auto grid grid-cols-5 text-center">
          ...
          <button 
            ...
            className="flex flex-col items-center text-emerald-600 dark:text-emerald-400 py-1 cursor-pointer"
          >
          ...
          <button 
            ...
            className="flex flex-col items-center text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 py-1 cursor-pointer"
          >
            <FaCalendarAlt className="text-base" />
            <span className="text-[9px] font-bold mt-0.5">Book Pickup</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] font-bold mt-0.5">My Pickups</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] font-bold mt-0.5">All Menu</span>
          </button>

        </div>
      </nav>

      {/* MOBILE DRAWER MODAL (All Menu / Hamburger) */}
      <AnimatePresence>
        {showDrawer && (
          <>
            <motion.div 
            ...
            >
              <div className="space-y-5">
                ...
                <div className="p-3 bg-emerald-50 dark:bg-emerald-950/40 rounded-2xl flex items-center space-x-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <span className="text-[10px] text-emerald-600 font-bold">
                      {walletPoints} EcoPoints (₹{inrValue})
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-1 text-xs font-bold">
                  <button 
                    ...
                    className="w-full text-left p-2 rounded-xl hover:bg-emerald-50 dark:hover:bg-slate-800 flex items-center space-x-2.5"
                  >
                  ...
                  >
                    ...
                    <span>Redeem Rewards & UPI Cash</span>
                  </button>
                  <button 
              ...
              <button 
                ...
                className="w-full py-2 bg-rose-500/10 text-rose-600 font-bold text-xs rounded-xl hover:bg-rose-500/20 transition"
              >
                Log Out
              </button>
            </motion.div>
