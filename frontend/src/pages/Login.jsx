        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center w-full">
          ...
          <div className="lg:col-span-6 flex justify-center">
            <div className="w-full max-w-[460px] bg-white/95 dark:bg-[#091b2e]/95 backdrop-blur-2xl border border-emerald-500/30 dark:border-emerald-500/40 p-6 sm:p-9 rounded-3xl shadow-2xl space-y-6">
              ...
              <div className="p-2 bg-slate-100 dark:bg-[#06121e] rounded-2xl border border-slate-200 dark:border-slate-800 text-xs flex items-center justify-between gap-2">
              ...
              <div className="text-center pt-2">
                <span className="text-xs text-slate-500 dark:text-slate-400 font-semibold">New to EcoReward? </span>
                <Link to="/signup" className="text-xs font-black text-emerald-500 hover:underline">
                  Create Account →
                </Link>
              </div>
