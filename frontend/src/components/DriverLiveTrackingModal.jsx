    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-lg bg-slate-900 border border-emerald-500/30 rounded-3xl p-5 sm:p-6 text-white shadow-2xl overflow-hidden max-h-[92vh] overflow-y-auto my-auto"
        >
          {/* Close Button */}
          <button
            onClick={onClose}
