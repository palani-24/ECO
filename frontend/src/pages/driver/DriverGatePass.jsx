...
const DriverGatePass = () => {
  ...
  const handleGenerateNewPass = (e) => {
    e.preventDefault();
    setPassGenerated(true);
    addToast('🎟️ Recycling Plant Digital Gate-Pass Issued!', 'success', 'Gate-Pass Generated');
  };
        ...
        <main className="flex-1 p-6 md:p-8 pb-24 md:pb-8 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800 p-6 rounded-3xl shadow-sm space-y-5">
              ...
              <form onSubmit={handleGenerateNewPass} className="space-y-4">
